...
| [2 Create a Security & Dependency Health table](https://github.com/futuroptimist/flywheel/blob/main/docs/prompts/codex/automation.md#2-create-a-security-dependency-health-table)   | one       |
