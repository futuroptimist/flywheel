### Cursor Rule – Flywheel Automation Baseline

Paste this rule into **Cursor → Settings → Rules** or save as
`.cursor/rules/flywheel-baseline.mdc`.

```md
---
description: Flywheel automation baseline
alwaysApply: true
---

### Flywheel Automation Instructions v4 (2025-09-xx)
# Repository scope
- Primary: flywheel/**
