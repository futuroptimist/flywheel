...
Use this prompt for a strict final merge-readiness check on a single pull request.
...
Use this prompt to improve the main prompt while preserving its strict merge-readiness behavior.
