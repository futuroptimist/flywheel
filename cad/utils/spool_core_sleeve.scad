...
//
//  Parameters:
//    inner_id   — measured bore ID (mm), e.g. 55
//    target_od  — outer diameter of sleeve (mm), e.g. 73 (≈AMS-friendly)
...
function _spool_core_sleeve_preset(preset) =
    (preset == "sunlu55_to73_len60") ? [55, 73, 60, 0.20] : undef;

module spool_core_sleeve_preset(
    preset = "sunlu55_to73_len60", $fn_outer = 200, $fn_inner = 150
) {
